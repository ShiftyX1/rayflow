...
// BedWars-specific player system.
// Migrated from engine/ecs/systems/player_system — game-specific logic
// (creative mode, tool selection, FPS camera, voxel::World dependency).
...
class BedwarsPlayerSystem : public System {
public:
