#include "bedwars_player_system.hpp"
...
void BedwarsPlayerSystem::update(entt::registry& registry, float delta_time) {
...
entt::entity BedwarsPlayerSystem::create_player(entt::registry& registry, const rf::Vec3& spawn_position) {
    ...
    collider.size = {engine::kPlayerWidth, engine::kPlayerHeight, engine::kPlayerWidth};
    ...
    camera.eye_height = engine::kPlayerEyeHeight;
    camera.fov = 60.0f;
...
Camera3D BedwarsPlayerSystem::get_camera(entt::registry& registry, entt::entity player) {
...
void BedwarsPlayerSystem::handle_movement(entt::registry& registry, float delta_time) {
...
void BedwarsPlayerSystem::handle_jumping(entt::registry& registry) {
...
void BedwarsPlayerSystem::handle_creative_mode(entt::registry& registry) {
...
void BedwarsPlayerSystem::handle_tool_selection(entt::registry& registry) {
