#include "voxel_physics_system.hpp"
...
void VoxelPhysicsSystem::update(entt::registry& registry, float delta_time) {
    apply_gravity(registry, delta_time);
    apply_velocity(registry, delta_time);
}

void VoxelPhysicsSystem::apply_gravity(entt::registry& registry, float delta_time) {
...
void VoxelPhysicsSystem::apply_velocity(entt::registry& registry, float delta_time) {
...
bool VoxelPhysicsSystem::check_block_collision(const rf::Vec3& position, const rf::Vec3& size) {
