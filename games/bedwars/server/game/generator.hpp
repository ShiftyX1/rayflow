...
struct Generator {
    ...
    // Type and timing
    bedwars::game::GeneratorTier tier{bedwars::game::GeneratorTier::Iron};
    ...
    bedwars::game::TeamId ownerTeam{0};
    ...
    bedwars::game::ItemType item_type() const;
...
struct DroppedItem {
    ...
    // Item info
    bedwars::game::ItemType itemType{bedwars::game::ItemType::None};
...
public:
    ...
    void upgrade_team_generators(bedwars::game::TeamId team, std::uint8_t level);
